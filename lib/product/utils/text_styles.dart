...
class Styles {
  ...
  static TextStyle mediumFontStyle({double? fontSize, Color? color, double? height}) =>
      GoogleFonts.tinos(
        letterSpacing: 0.7,
  ...
  static TextStyle largeWhiteFontStyle({double? fontSize, Color? color, double? height}) =>
      GoogleFonts.tinos(
        letterSpacing: 0.7,
  ...
  static TextStyle normalWhiteBoldFontStyle({double? fontSize, Color? color, double? height}) =>
      GoogleFonts.tinos(
        letterSpacing: 0.7,
